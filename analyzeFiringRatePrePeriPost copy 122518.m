...
% matFilenames={['../data/' rStr '/SmartboxRecording Pre TUS_20181203-163325.mat'];
%     ['../data/' rStr '/SmartboxRecording Peri TUS_20181203-164839.mat'];
%     ['../data/' rStr '/SmartboxRecording Post TUS_20181203-165310.mat']};

% matFilenames={%'../data/r008/r008_Pre_Sham_10Hz_20181210_152756.mat';
%     %'../data/r008/r008_Dur_Sham_10Hz_20181210_153210.mat';
%     %'../data/r008/r008_Pos_Sham_10Hz_20181210_153525.mat'};
%     '../data/r008/r008_Pre_Active_10Hz_20181210_153905.mat';
%     '../data/r008/r008_Dur_Active_10Hz_20181210_154259.mat';
%     '../data/r008/r008_Pos_Active_10Hz_20181210_154635.mat'};

% matFilenames={'../data/r009/SmartboxRecording pre active10Hz_20181217-145033.mat',...
%     '../data/r009/SmartboxRecording dur active10Hz_20181217-145701.mat',...
%     '../data/r009/SmartboxRecording post active10Hz_20181217-150032.mat'};

%matFilenames={'../data/r008/r008_Pre_Sham_40Hz_20181210_160137.mat';
%   '../data/r008/r008_Dur_Sham_40Hz_20181210_160531.mat';
%   '../data/r008/r008_Pos_Sham_40Hz_20181210_160913.mat'};

% matFilenames={'../data/r008/r008_Pre_Active_40Hz_20181210_161257.mat';
%     '../data/r008/r008_Dur_Active_40Hz_20181210_161709.mat';
%     '../data/r008/r008_Pos_Active_40Hz_20181210_162047.mat'};
...
%samples={60*9*fs+1:60*10*fs;60*0*fs+1:60*1*fs;60*0*fs+1:60*1*fs}; % 1 min
