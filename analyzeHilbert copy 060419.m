...
%excluding r012
% rStrs={'r013','r014','r015','r016','r017','r018','r019'};
...
for c=1:8
    c
    grandMeansCorrDown(c,:)=resample(grandMeansCorr(c,:),1,50);
end
timeBslDown=timeBsl(1:50:end); 
timePostDown=timePost(1:50:end); 
...
plot(timeBslDown,grandMeansCorrDown(c,1:numel(timeBslDown)))
plot(timePostDown,grandMeansCorrDown(c,numel(timeBslDown)+1:end))
